...
import { devolverArchivoDelBucket, subirArchivoAlBucket, devolverURLDeSubidaDelBucket, eliminarArchivoDelBucket } from "../utils/manejo_archivos_s3.js";
...
export const generarUrlDelBacket = async (req, res) => {
...
export const eliminarArchivo = async (req, res) => {
    ...
    const archivoEncontrado = await prisma.archivo.findFirstOrThrow({
        where: { id },
    });
